...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  [ErrorCode.AUTH_TOKEN_INVALID]:
    'Sesi Anda tidak valid. Silakan masuk ulang.',
  [ErrorCode.AUTH_TOKEN_EXPIRED]:
    'Sesi Anda sudah habis. Silakan masuk ulang.',
  [ErrorCode.AUTH_REFRESH_TOKEN_INVALID]:
    'Sesi Anda sudah kadaluarsa. Silakan masuk ulang.',
  [ErrorCode.AUTH_UNAUTHORIZED]:
    'Anda tidak punya izin untuk melakukan ini.',
  [ErrorCode.AUTH_FORBIDDEN]:
    'Maaf, akses ini hanya untuk admin.',
  ...
  [ErrorCode.SYNC_JOB_NOT_FOUND]:
    'Tugas sinkronisasi tidak ditemukan.',
  [ErrorCode.SYNC_BATCH_TOO_LARGE]:
    'Terlalu banyak data sekaligus. Kirim maksimal 100 data per batch.',
  [ErrorCode.SYNC_CONFLICT]:
    'Ada konflik data. Data terbaru yang dipakai.',
  [ErrorCode.SYNC_OWNERSHIP_MISMATCH]:
    'Perangkat ini bukan milik Anda.',

  // ─── Data ───────────────────────────────────────────────
  [ErrorCode.DATA_NOT_FOUND]:
    'Data tidak ditemukan.',
  [ErrorCode.DATA_OWNERSHIP_DENIED]:
  ...
  [ErrorCode.AI_REQUEST_FAILED]:
    'Gagal memproses permintaan AI. Coba lagi.',
