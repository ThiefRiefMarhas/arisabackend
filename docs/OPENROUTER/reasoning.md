...
<Note title='Model Support'>
  ...
  <ul>
    <li>Alibaba: Qwen3.5 and newer</li>
    <li>Arcee AI: Trinity Large Thinking and newer</li>
    <li>MiniMax: MiniMax M2 and newer</li>
    <li>MoonShot: Kimi K2 Thinking and newer</li>
    <li>NVIDIA: Nemotron 3 Nano and newer</li>
    <li>Prime Intellect: INTELLECT-3</li>
    <li>Xiaomi: MiMo-V2-Flash and newer</li>
    <li>Z.ai: GLM 4.5 and newer</li>
  </ul>
